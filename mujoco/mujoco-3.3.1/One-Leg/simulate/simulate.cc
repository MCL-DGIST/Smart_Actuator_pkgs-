...
void makecontrolpanel(mj::Simulate* sim){
  // switches section of UI
    
  const mjuiDef defControlPanel[] = {
    {mjITEM_SECTION,   "GAIN",       1, NULL,             ""},
    {mjITEM_EDITNUM,   "Kp",       2, &CP.kp,    "1"},
    {mjITEM_END}
  };
  mjui_add(&sim->ui1, defControlPanel);
}
